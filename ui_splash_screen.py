...
"}")
        ...
        self.label_title.setStyleSheet(u"color: rgb(1, 34, 67);")
...
"}")
        ...
        self.label_loading.setStyleSheet(u"color: rgb(1, 34, 67);")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<strong>Voice Over</strong> Creator", None))
